...
const ManufacturerManagement = () => {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            setManufacturers(Array.isArray(data) ? data : (data.result || []));
        } catch (error) {
            toast({ variant: "destructive", title: "Failed to load manufacturers" });
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingItem) {
                await updateManufacturer(editingItem.id, formData);
    ...
    return (
        <div className="space-y-6">
                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={5} className="h-24 text-center">No manufacturers found.</TableCell>
                            </TableRow>
                        ) : (
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>{editingItem ? 'Edit Manufacturer' : 'Create Manufacturer'}</DialogTitle>
                    </DialogHeader>
